## 📄 Créditos
Este projeto utiliza dados e funcionalidades do pacote [`datasus-fetcher`](https://pypi.org/project/datasus-fetcher/), desenvolvido por [Daniel Komesu](https://pypi.org/user/dankkom/).

# Instruções para uso das Bibliotecas originais
https://pypi.org/project/datasus-fetcher/

## 🗂️ Fontes de Dados
🔗 Consultas online – TABNET
...
SIA-ACF: Fístula Arteriovenosa

SIA-AD: Laudos Diversos

SIA-AM: Medicamentos

SIA-AN: Nefrologia

SIA-AQ: Quimioterapia

SIA-AR: Radioterapia

SIA-ATD: Tratamento Dialítico
...
SINAN-ANIM: Animais Peçonhentos
...
SINAN-CHAG: Doença de Chagas

SINAN-CHIK: Chikungunya
...
SINAN-LTAN: Leishmaniose Tegumentar

SINAN-MALA: Malária

SINAN-MENI: Meningite

SINAN-MENT: Transtornos mentais

SINAN-NTRA: Tracoma

SINAN-PAIR: Perda auditiva por ruído

SINAN-PEST: Peste

SINAN-PFAN: Paralisia Flácida Aguda

SINAN-PNEU: Pneumoconioses

SINAN-RAIV: Raiva

SINAN-ROTA: Rotavírus

SINAN-SDTA: Surto por Alimentos
...
SINAN-VIOL: Violência doméstica e sexual
